    ...
    <section className="h-screen relative overflow-hidden bg-grey flex flex-col justify-center items-center">
      <div className="container mx-auto">
        <div className="flex items-center justify-center h-full">
          {/* Imagem */}
          <div className=" xl:flex h-[88%] w-full absolute inset-0 z-0 opacity-50">
            <Image
              src="/bg/bg-cwb.jpg"
              layout="fill"
              objectFit="cover"
          ...
          <div className="w-full xl:max-w-[500px] flex flex-col justify-center items-center absolute z-10">
            ...
            <span className="text-xl px-4 text-center font-semibold mt-4 text-gray-800 italic md:whitespace-wrap">
        ...
        <div className="flex justify-center mt-40">
          <svg
            ...
            className="h-8 w-8 text-gray-800 animate-bounce"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
              fillRule="evenodd"
              d="M10 2a1 1 0 0 1 1 1v11.586l2.293-2.293a1 1 0 1 1 1.414 1.414l-4 4a1 1 0 0 1-1.414 0l-4-4a1 1 0 1 1 1.414-1.414L9 14.586V3a1 1 0 0 1 1-1z"
              clipRule="evenodd"
            />
          </svg>
        </div>
